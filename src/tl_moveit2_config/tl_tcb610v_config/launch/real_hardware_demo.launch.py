...
def generate_launch_description():
    moveit_config = MoveItConfigsBuilder(
        "tl_tcb610v", package_name="tl_tcb610v_config"
    ).to_moveit_configs()

    pkg_share = get_package_share_directory("tl_tcb610v_config")
    xacro_path = os.path.join(pkg_share, "config", "tl_tcb610v.urdf.xacro")
