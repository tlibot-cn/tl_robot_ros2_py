...
def generate_launch_description():
    moveit_config = MoveItConfigsBuilder(
        "tl_tcb705", package_name="tl_tcb705_config"
    ).to_moveit_configs()

    pkg_share = get_package_share_directory("tl_tcb705_config")
    xacro_path = os.path.join(pkg_share, "config", "tl_tcb705.urdf.xacro")
