#ifndef INCLUDE_CPP_PARAMETER_NRC_CRAFT_TRACK_PARAMETER_H_
#define INCLUDE_CPP_PARAMETER_NRC_CRAFT_TRACK_PARAMETER_H_
...
#endif/*INCLUDE_CPP_PARAMETER_NRC_CRAFT_WELD_PARAMETER_H_*/