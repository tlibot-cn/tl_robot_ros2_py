...
class CRobotDHParam(ctypes.Structure):
    _fields_ = [
        ...
        ("L19", ctypes.c_double),
        ("L20", ctypes.c_double),
        ("Couple_Coe_1_2", ctypes.c_double),
        ("Couple_Coe_2_3", ctypes.c_double),
        ("Couple_Coe_3_2", ctypes.c_double),
        ("Couple_Coe_3_4", ctypes.c_double),
        ("Couple_Coe_4_5", ctypes.c_double),
        ("Couple_Coe_4_6", ctypes.c_double),
        ("Couple_Coe_5_6", ctypes.c_double),
        ("dynamicLimit_max", ctypes.c_int),
        ("dynamicLimit_min", ctypes.c_int),
        ("pitch", ctypes.c_double),
        ("sliding_lead_value", ctypes.c_double),
        ("uplift_lead_value", ctypes.c_double),
        ("spray_distance", ctypes.c_double),
        ("threeAxisDirection", ctypes.c_int),
        ("fiveAxisDirection", ctypes.c_int),
        ("twoAxisConversionRatio", ctypes.c_double),
        ("threeAxisConversionRatio", ctypes.c_double),
        ("amplificationRatio", ctypes.c_double),
        ("conversionratio_x", ctypes.c_double),
        ("conversionratio_y", ctypes.c_double),
        ("conversionratio_z", ctypes.c_double),
        ("conversionratio_J1", ctypes.c_double),
        ("conversionratio_J2", ctypes.c_double),
        ("conversionratio_J3", ctypes.c_double),
        ("upsideDown", ctypes.c_int),
        ("hanyu", ctypes.c_int),
    ]
...
class CRobotJointParam(ctypes.Structure):
    _fields_ = [
        ("reducRatio", ctypes.c_double),
        ("encoderResolution", ctypes.c_double),
        ("posSWLimit", ctypes.c_double),
        ("negSWLimit", ctypes.c_double),
        ("ratedRotSpeed", ctypes.c_double),
        ("deRatedRotSpeed", ctypes.c_double),
        ("maxRotSpeed", ctypes.c_double),
        ("maxDeRotSpeed", ctypes.c_double),
        ("ratedVel", ctypes.c_double),
        ("deRatedVel", ctypes.c_double),
        ("maxAcc", ctypes.c_double),
        ("maxDecel", ctypes.c_double),
...
class CIndependentAxisParam(ctypes.Structure):
    _fields_ = [
        ...
        ("angular_distance_conversion_ratio_value", ctypes.c_double),
        ("is_track", ctypes.c_bool),
        ("encoder_bit_linedit_value", ctypes.c_int),
        ("inverse_limit_value", ctypes.c_double),
        ("maximum_positive_speed_value", ctypes.c_double),
        ("maximum_reverse_speed_value", ctypes.c_double),
        ("motor_dir", ctypes.c_int),
        ("positive_limit_value", ctypes.c_double),
        ("rated_positive_speed_value", ctypes.c_double),
        ("rated_reverse_speed_value", ctypes.c_double),
        ("reduction_ratio_value", ctypes.c_double),
        ("max_acc_value", ctypes.c_double),
        ("max_dec_value", ctypes.c_double),
...
def connect_robot(ip: str, port: str) -> int:
    return _make_func("connect_robot", [ctypes.c_char_p, ctypes.c_char_p])(
        ip.encode(), port.encode()
    )
...
def set_servo_state_robot(socketFd: int, robotNum: int, state: int) -> int:
    return _make_func("set_servo_state_robot", [SOCKETFD, ctypes.c_int, ctypes.c_int])(
        socketFd, robotNum, state
    )


def get_servo_state(socketFd: int) -> int:
    status = ctypes.c_int()
    ret = _make_func("get_servo_state", [SOCKETFD, ctypes.POINTER(ctypes.c_int)])(
        socketFd, ctypes.byref(status)
    )
...
def get_servo_state_robot(socketFd: int, robotNum: int) -> int:
    status = ctypes.c_int()
    ret = _make_func(
        "get_servo_state_robot", [SOCKETFD, ctypes.c_int, ctypes.POINTER(ctypes.c_int)]
    )(socketFd, robotNum, ctypes.byref(status))
    return status.value if ret == SUCCESS else ret
...
# ---------- 运动控制 ----------
def robot_movej(
    socketFd: int, coord: int, vel: float, acc: float, dec: float, targetPos: tuple
) -> int:
...
def get_current_position(socketFd: int, coord: int) -> list:
    ...
    ret = _make_func(
        "get_current_position", [SOCKETFD, ctypes.c_int, ctypes.POINTER(ctypes.c_double)]
    )(socketFd, coord, pos)
    if ret == SUCCESS:
...
def get_current_position_robot(socketFd: int, robotNum: int, coord: int) -> list:
    ...
    ret = _make_func(
        ...
        [SOCKETFD, ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_double)],
    )(socketFd, robotNum, coord, pos)
    if ret == SUCCESS:
        return [pos[i] for i in range(7)]
    return []
...
def get_speed(socketFd: int) -> int:
    sp = ctypes.c_int()
    ret = _make_func("get_speed", [SOCKETFD, ctypes.POINTER(ctypes.c_int)])(
        socketFd, ctypes.byref(sp)
    )
...
def get_joint_position(socketFd: int, axisNum: int = 0) -> list:
    ...
    pos = (ctypes.c_double * 7)()
    ret = _make_func(
        "get_joint_position", [SOCKETFD, ctypes.c_int, ctypes.POINTER(ctypes.c_double)]
    )(socketFd, axisNum, pos)
...
def get_current_extra_position(socketFd: int) -> list:
    ...
    ret = _make_func("get_current_extra_position", [SOCKETFD, ctypes.POINTER(ctypes.c_double)])(
        socketFd, pos
    )
...
def get_current_coord(socketFd: int) -> int:
    coord = ctypes.c_int()
    ret = _make_func("get_current_coord", [SOCKETFD, ctypes.POINTER(ctypes.c_int)])(
        socketFd, ctypes.byref(coord)
    )
...
def get_current_mode(socketFd: int) -> int:
    mode = ctypes.c_int()
    ret = _make_func("get_current_mode", [SOCKETFD, ctypes.POINTER(ctypes.c_int)])(
        socketFd, ctypes.byref(mode)
    )
...
def get_robot_running_state(socketFd: int) -> int:
    state = ctypes.c_int()
    ret = _make_func("get_robot_running_state", [SOCKETFD, ctypes.POINTER(ctypes.c_int)])(
        socketFd, ctypes.byref(state)
    )
...
def get_current_motor_torque(socketFd: int) -> tuple:
    ...
    ret = _make_func(
        ...
        [SOCKETFD, ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int)],
...
def get_current_line_speed_and_joint_speed(socketFd: int) -> tuple:
    ...
    ret = _make_func(
        "get_current_line_speed_and_joint_speed",
        [
            SOCKETFD,
            ctypes.POINTER(ctypes.c_double),
            ctypes.POINTER(ctypes.c_double),
    ...
    if ret == SUCCESS:
        return (
            ret,
            line_speed.value,
            [joint_speed[i] for i in range(5)],
            [joint_speed_sync[i] for i in range(5)],
        )
    return (ret, 0.0, [], [])
...
def set_global_sync_position(socketFd: int, posName: str, posInfo: list) -> int:
    ...
    return _make_func(
        "set_global_sync_position", [SOCKETFD, ctypes.c_char_p, ctypes.POINTER(ctypes.c_double)]
    )(socketFd, posName.encode(), arr)


def get_global_sync_position(socketFd: int, posName: str) -> list:
    arr = (ctypes.c_double * 21)()
    ret = _make_func(
        "get_global_sync_position", [SOCKETFD, ctypes.c_char_p, ctypes.POINTER(ctypes.c_double)]
    )(socketFd, posName.encode(), arr)
...
def set_global_position(socketFd: int, posName: str, posInfo: list) -> int:
    ...
    return _make_func(
        "set_global_position", [SOCKETFD, ctypes.c_char_p, ctypes.POINTER(ctypes.c_double)]
    )(socketFd, name, arr)
...
def get_global_position(socketFd: int, posName: str) -> list:
    ...
    ret = _make_func(
        "get_global_position", [SOCKETFD, ctypes.c_char_p, ctypes.POINTER(ctypes.c_double)]
    )(socketFd, name, arr)
    if ret == SUCCESS:
...
def set_global_variant(socketFd: int, varName: str, value: float) -> int:
    name = varName.encode()
    return _make_func("set_global_variant", [SOCKETFD, ctypes.c_char_p, ctypes.c_double])(
        socketFd, name, value
    )
...
def get_global_variant(socketFd: int, varName: str) -> float:
    ...
    val = ctypes.c_double()
    ret = _make_func(
        "get_global_variant", [SOCKETFD, ctypes.c_char_p, ctypes.POINTER(ctypes.c_double)]
    )(socketFd, name, ctypes.byref(val))
    return val.value if ret == SUCCESS else 0.0


# ---------- 坐标转换 ----------
def origin_to_target_coord(
    socketFd: int, originCoord: int, originPos: list, targetCoord: int
) -> list:
    ...
    )(socketFd, originCoord, o, targetCoord, t)
    if ret == SUCCESS:
...
def get_robot_switch(socketFd: int) -> int:
    robot = ctypes.c_int()
    ret = _make_func("get_robot_switch", [SOCKETFD, ctypes.POINTER(ctypes.c_int)])(
        socketFd, ctypes.byref(robot)
    )
...
def get_robot_dh_param(socketFd: int, param: CRobotDHParam) -> int:
    ...
    return _make_func("get_robot_dh_param", [SOCKETFD, ctypes.POINTER(CRobotDHParam)])(
        socketFd, ctypes.byref(param)
    )


def get_robot_joint_param(socketFd: int, joint_id: int, param: CRobotJointParam) -> int:
    return _make_func(
        "get_robot_joint_param", [SOCKETFD, ctypes.c_int, ctypes.POINTER(CRobotJointParam)]
    )(socketFd, joint_id, ctypes.byref(param))


# ---------- SDO ----------
def set_axis_sdo(
    socketFd: int, axisNum: int, index: int, subindex: int, value: int, size: int
) -> int:
    return _make_func(
        "set_axis_sdo",
        [SOCKETFD, ctypes.c_int, ctypes.c_uint, ctypes.c_uint, ctypes.c_int, ctypes.c_uint],
    )(socketFd, axisNum, index, subindex, value, size)
...
def job_get_all_jobfile_name(socketFd: int, robotNum: int, buffer, maxFileNum: int) -> int:
    ...
    return _make_func(
        "job_get_all_jobfile_name", [SOCKETFD, ctypes.c_int, ctypes.c_void_p, ctypes.c_size_t]
    )(socketFd, robotNum, buffer, maxFileNum)


def job_upload_by_directory(socketFd: int, directoryPath: str) -> int:
    return _make_func("job_upload_by_directory", [SOCKETFD, ctypes.c_char_p])(
        socketFd, directoryPath.encode()
    )


def job_upload_by_file(socketFd: int, filePath: str) -> int:
    return _make_func("job_upload_by_file", [SOCKETFD, ctypes.c_char_p])(
        socketFd, filePath.encode()
    )
...
def job_download_by_directory(socketFd: int, directoryPath: str, isCover: bool) -> int:
    return _make_func("job_download_by_directory", [SOCKETFD, ctypes.c_char_p, ctypes.c_bool])(
        socketFd, directoryPath.encode(), isCover
    )


def log_download_by_quantity(socketFd: int, counts: int, directoryPath: str) -> int:
    return _make_func("log_download_by_quantity", [SOCKETFD, ctypes.c_int, ctypes.c_char_p])(
        socketFd, counts, directoryPath.encode()
    )
...
def job_get_command_total_lines(socketFd: int) -> int:
    total = ctypes.c_int()
    ret = _make_func("job_get_command_total_lines", [SOCKETFD, ctypes.POINTER(ctypes.c_int)])(
        socketFd, ctypes.byref(total)
    )
...
def job_get_command_content_by_line(socketFd: int, line: int, buf_size: int = 256) -> str:
    ...
    ret = _make_func("job_get_command_content_by_line", [SOCKETFD, ctypes.c_int, ctypes.c_char_p])(
        socketFd, line, buf
    )
...
def job_step(socketFd: int, jobName: str, line: int) -> int:
    return _make_func("job_step", [SOCKETFD, ctypes.c_char_p, ctypes.c_int])(
        socketFd, jobName.encode(), line
    )
...
def job_break_point_run(socketFd: int, jobName: str) -> int:
    return _make_func("job_break_point_run", [SOCKETFD, ctypes.c_char_p])(
        socketFd, jobName.encode()
    )
...
def job_get_current_line(socketFd: int) -> int:
    line = ctypes.c_int()
    ret = _make_func("job_get_current_line", [SOCKETFD, ctypes.POINTER(ctypes.c_int)])(
        socketFd, ctypes.byref(line)
    )
    return line.value if ret == SUCCESS else ret


def job_insert_moveJ(
    socketFd: int, line: int, vel: float, acc: float, dec: float, pl: int, posName: str
) -> int:
    return _make_func(
        "job_insert_moveJ",
        [
    ...
    )(socketFd, line, vel, acc, dec, pl, posName.encode())


def job_insert_moveL(
    socketFd: int, line: int, vel: float, acc: float, dec: float, pl: int, posName: str
) -> int:
    return _make_func(
        "job_insert_moveL",
...
def queue_motion_send_to_controller(socketFd: int, size: int, isContinue: bool = False) -> int:
    return _make_func("queue_motion_send_to_controller", [SOCKETFD, ctypes.c_int, ctypes.c_bool])(
        socketFd, size, isContinue
    )


def queue_motion_push_back_moveJ(
    socketFd: int, coord: int, vel: float, acc: float, dec: float, pl: int, targetPos: tuple
) -> int:
    arr = (ctypes.c_double * 7)(*targetPos[:7])
    return _make_func(
...
def queue_motion_push_back_moveL(
    socketFd: int, coord: int, vel: float, acc: float, dec: float, pl: int, targetPos: tuple
) -> int:
    arr = (ctypes.c_double * 7)(*targetPos[:7])
    return _make_func(
...
def queue_motion_push_back_dout(socketFd: int, port: int, value: bool) -> int:
    return _make_func("queue_motion_push_back_dout", [SOCKETFD, ctypes.c_int, ctypes.c_bool])(
        socketFd, port, value
    )
...
def queue_motion_push_back_moveC(
    socketFd: int, coord: int, vel: float, acc: float, dec: float, pl: int, targetPos: tuple
) -> int:
    arr = (ctypes.c_double * 7)(*targetPos[:7])
    return _make_func(
...
def queue_motion_push_back_moveCA(
    socketFd: int, coord: int, vel: float, acc: float, dec: float, pl: int, targetPos: tuple
) -> int:
    arr = (ctypes.c_double * 7)(*targetPos[:7])
    return _make_func(
...
def queue_motion_push_back_moveS(
    socketFd: int, coord: int, vel: float, acc: float, dec: float, pl: int, targetPos: tuple
) -> int:
    arr = (ctypes.c_double * 7)(*targetPos[:7])
    return _make_func(
...
def queue_motion_push_back_moveJ_extra(
    socketFd: int, coord: int, vel: float, acc: float, dec: float, pl: int, targetPos: tuple
) -> int:
...
def queue_motion_push_back_moveL_extra(
    socketFd: int, coord: int, vel: float, acc: float, dec: float, pl: int, targetPos: tuple
) -> int:
    if len(targetPos) != 14:
...
def modify_independent_axis_param(socketFd: int, param: CIndependentAxisParam) -> int:
    return _make_func(
        "modify_independent_axis_param", [SOCKETFD, ctypes.POINTER(CIndependentAxisParam)]
    )(socketFd, ctypes.byref(param))
...
def get_independent_axis_param(socketFd: int, axis_num: int) -> CIndependentAxisParam:
    ...
    ret = _make_func(
        "get_independent_axis_param",
        [SOCKETFD, ctypes.c_int, ctypes.POINTER(CIndependentAxisParam)],
    )(socketFd, axis_num, ctypes.byref(param))
    return param if ret == SUCCESS else None


def get_axis_sum(socketFd: int) -> int:
    total = ctypes.c_int()
    ret = _make_func("get_axis_sum", [SOCKETFD, ctypes.POINTER(ctypes.c_int)])(
        socketFd, ctypes.byref(total)
    )
    return total.value if ret == SUCCESS else ret
...
def get_axis_position(socketFd: int, axis_num: int) -> float:
    pos = ctypes.c_double()
    ret = _make_func(
        "get_axis_position", [SOCKETFD, ctypes.c_int, ctypes.POINTER(ctypes.c_double)]
    )(socketFd, axis_num, ctypes.byref(pos))
    return pos.value if ret == SUCCESS else 0.0


def independent_axis_zero_calibration(socketFd: int, axis_num: int) -> int:
    return _make_func("independent_axis_zero_calibration", [SOCKETFD, ctypes.c_int])(
        socketFd, axis_num
    )
...
def set_independent_axis_PV_run(socketFd: int, param: CIndependentAxisRun) -> int:
    return _make_func(
        "set_independent_axis_PV_run", [SOCKETFD, ctypes.POINTER(CIndependentAxisRun)]
    )(socketFd, ctypes.byref(param))
...
def independent_axis_jog(socketFd: int, param: CIndependentAxisRun) -> int:
    return _make_func("independent_axis_jog", [SOCKETFD, ctypes.POINTER(CIndependentAxisRun)])(
        socketFd, ctypes.byref(param)
    )
...
def open_servoJ(socketFd: int, vmax: list, amax: list, jmax: list) -> int:
    ...
    _wrapper.open_servoJ_wrapper.argtypes = [
        ctypes.c_int,
        ctypes.POINTER(ctypes.c_double),
        ctypes.c_int,
        ctypes.POINTER(ctypes.c_double),
...
def set_servoJ_pos(socketFd: int, q: list) -> int:
    ...
    _wrapper.set_servoJ_pos_wrapper.argtypes = [
        ctypes.c_int,
        ctypes.POINTER(ctypes.c_double),
        ctypes.c_int,
    ]
...
# 末端 IO
def set_terminal_io_can_param(
    socketFd: int, id: int, port: int, arbitration_baudrate: int, data_baudrate: int
) -> int:
    return _modbus_func(
        "set_terminal_io_can_param",
        [SOCKETFD, ctypes.c_int, ctypes.c_int, ctypes.c_int, ctypes.c_int],
    )(socketFd, id, port, arbitration_baudrate, data_baudrate)


def set_terminal_io_485_param(socketFd: int, id: int, port: int, baudrate: int) -> int:
    return _modbus_func(
        "set_terminal_io_485_param", [SOCKETFD, ctypes.c_int, ctypes.c_int, ctypes.c_int]
    )(socketFd, id, port, baudrate)


def terminal_io_read_modbus_data(
    socketFd: int, func_code: int, start_addr: int, read_addr_num: int
) -> list:
    arr = (ctypes.c_int * read_addr_num)()
    ret = _modbus_func(
        "terminal_io_read_modbus_data",
        [SOCKETFD, ctypes.c_int, ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_int)],
    )(socketFd, func_code, start_addr, read_addr_num, arr)
    if ret == SUCCESS:
        return [arr[i] for i in range(read_addr_num)]
    return []


def terminal_io_write_modbus_data(
    socketFd: int, func_code: int, start_addr: int, write_data: list
) -> int:
    n = len(write_data)
    arr = (ctypes.c_int * n)(*write_data)
    return _modbus_func(
        "terminal_io_write_modbus_data",
        [SOCKETFD, ctypes.c_int, ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_int)],
    )(socketFd, func_code, start_addr, n, arr)


# 主站配置
def modbus_set_master_parameter_tcp(
    socketFd: int, id: int, ip: str, port: int, startAddress: bool = False
) -> int:
    """设置 Modbus TCP 主站参数"""
    return _modbus_func(
        "modbus_set_master_parameter_simple",
        [
            SOCKETFD,
            ctypes.c_int,
...
def modbus_set_master_parameter_rtu(
    socketFd: int,
    id: int,
    slaveId: int,
    rtu_port: int,
    ...
    dataBit: int = 8,
    stopBit: int = 1,
    startAddress: bool = False,
) -> int:
    """设置 Modbus RTU 主站参数"""
    return _modbus_func(
        "modbus_set_master_parameter_rtu_simple",
        [
            SOCKETFD,
            ctypes.c_int,
            ctypes.c_int,
...
def modbus_get_master_connection_status(socketFd: int, id: int) -> int:
    ...
    ret = _modbus_func(
        ...
        [SOCKETFD, ctypes.c_int, ctypes.POINTER(ctypes.c_int)],
    )(socketFd, id, ctypes.byref(status))
    return status.value if ret == SUCCESS else ret
...
def modbus_read_coil_status(socketFd: int, id: int, address: int, quantity: int) -> list:
    ...
    ret = _modbus_func(
        ...
        [SOCKETFD, ctypes.c_int, ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_int)],
    )(socketFd, id, address, quantity, arr)
    if ret == SUCCESS:
...
def modbus_write_signal_coil_status(socketFd: int, id: int, address: int, data: int) -> int:
    return _modbus_func(
        "modbus_write_signal_coil_status", [SOCKETFD, ctypes.c_int, ctypes.c_int, ctypes.c_int]
    )(socketFd, id, address, data)
...
def modbus_write_signal_holding_registers(socketFd: int, id: int, address: int, data: int) -> int:
    return _modbus_func(
        ...
        [SOCKETFD, ctypes.c_int, ctypes.c_int, ctypes.c_int],
    )(socketFd, id, address, data)
...
def modbus_write_multiple_coil_status(socketFd: int, id: int, address: int, data: list) -> int:
    ...
    return _modbus_func(
        ...
        [SOCKETFD, ctypes.c_int, ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_int)],
    )(socketFd, id, address, n, arr)


def modbus_write_multiple_holding_registers(
    socketFd: int, id: int, address: int, data: list
) -> int:
    n = len(data)
    arr = (ctypes.c_int * n)(*data)
    return _modbus_func(
...
__all__ = [
    ...
    "set_axis_sdo",
    # 独立轴
    "new_independent_axis_param",
    "modify_independent_axis_param",
    "get_independent_axis_param",
    "get_axis_sum",
    "delete_axis_sum",
    "get_axis_position",
